...
class RunnerPane(object):
    def __init__(self,master):
        ...
        create_tool_tip(self.button, text='open Windows Command Processor (cmd)\nin the current directory')
        ...
        create_tool_tip(self.chooserunner, text="Choose the runner to run\nthe currently opened\ntab..")
        ...
        create_tool_tip(self.newrunbtn, text='Create a new runner \nand save to\nrunners file')
        frame.grid()
...
class LooksPane(object):
    ...
    def __init__(self,master):
        ...
        create_tool_tip(self.b, text='Select The color-scheme\nto use..')
        ...
        create_tool_tip(self.c, text='Select the programming language\nsyntax to use')
        ...
        create_tool_tip(self.g, text='Add a new window title')
        ...
        create_tool_tip(self.i, text='Write the font to be used\nsyntax: "NAME SIZE"')
        ...
        create_tool_tip(self.j, text='Shall you use Block Cursor\ninstead of normal "thin" one?')
...
class PathView(object):
    ...
    def __init__(self, master, paths):
        ...
        create_tool_tip(self.newfilebtn, text='New Tab')
        create_tool_tip(self.newfoldbtn, text='Add Folder')
        create_tool_tip(self.closetabtn, text='Close Tab')
...
create_tool_tip(tkterm_clear, "Clear the terminal")
create_tool_tip(tkterm_reset, "Restart the terminal\nJust in case you crashed..")
